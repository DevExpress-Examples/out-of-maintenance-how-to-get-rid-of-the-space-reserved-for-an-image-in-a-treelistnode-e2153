...
Namespace B3013
    Partial Public Class MainForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.myTreeList1.AppendNode(New Object() { "Root 1"}, -1, 2, 0, 1)
            Me.myTreeList1.AppendNode(New Object() { "Child 1"}, 0, 2, -1, 1)
            Me.myTreeList1.AppendNode(New Object() { "Root 2"}, -1, 2, 0, -1)
            Me.myTreeList1.AppendNode(New Object() { "Child 2"}, 2, 2, -1, -1)
            Me.myTreeList1.AppendNode(New Object() { "Child 3"}, 2, 2, 0, 1)
            ...
            Me.treeListColumn1.MinWidth = 71
        ...
        Private myTreeList1 As TreeList
